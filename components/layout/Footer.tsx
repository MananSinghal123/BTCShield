      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 text-sm mb-4 max-w-md">
              Professional BTC backstop protection platform with institutional-grade analytics 
              and advanced risk management tools for the modern crypto ecosystem.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/borrow" className="text-gray-400 hover:text-white text-sm transition-colors">Borrow</Link></li>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 OptiLend. All rights reserved.
          </p>
